...
def run_automl():
    for file_csv in os.listdir(dataset_dir):
        ...
        automl = AutoML(algorithms=algorithm_list, eval_metric='f1', results_path=results_dir+file_csv.split('.')[0], explain_level=1, top_models_to_improve=4, random_state=2)
